...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    static POINT apt[4];
	TCHAR  *light[] = {TEXT("Red"), TEXT("Yellow"), TEXT("Green")};
	static HWND hctlWnd[3];
	...
	case WM_CREATE:
		...
		for (int i=0; i<3; ++i) {
			hctlWnd[i] = CreateWindow(TEXT("button"), light[i], 
									  BS_RADIOBUTTON | WS_CHILD | WS_VISIBLE,
									  cxChar/2, cyChar*(2*i+2), 
									  20*cxChar, 7*cyChar/4,
									  hWnd, (HMENU)(i+1), hInst, NULL);
		}

		hwndGroup = CreateWindow(TEXT("button"), TEXT("红绿灯"),
								 BS_GROUPBOX | WS_CHILD | WS_VISIBLE,
								 cxChar/4, 0, 21*cxChar, 9*cyChar, 
								 hWnd, 0, hInst, NULL);


		hChecked = hctlWnd[0];
		SendMessage(hChecked, BM_SETCHECK, 1, 0L);
		break;
    case WM_SIZE:
        ...
        break;
	case WM_COMMAND:
		SendMessage(hChecked, BM_SETCHECK, 0, 0L);
		hChecked = (HWND)LOWORD(lParam);
		SendMessage(hChecked, BM_SETCHECK, 1, 0L);
