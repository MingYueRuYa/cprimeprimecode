...
QString SimpleCrypt::Encrypt(const QString &pEncryptStr)
{
    QByteArray plaintextArray = pEncryptStr.toUtf8();
    QByteArray cypher = encryptToByteArray(plaintextArray);
    QString cypherString = QString::fromLatin1(cypher.toBase64());
    return cypherString;
}

QString SimpleCrypt::Decrypt(const QString &pDecryptStr)
{
    QByteArray cyphertextArray = QByteArray::fromBase64(pDecryptStr.toLatin1());
